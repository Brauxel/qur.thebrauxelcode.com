	...
	<main id="home-page">
		<div class="slider-container">
			<div class="slide-content">
				...
				<h1 class="one show"><a href="<?php bloginfo('url'); ?>/projects/thompson-brothers-lithium-project/">Lithium Acquisition In Manitoba Canada</a></h1>
				<h1 class="two"><a href="<?php bloginfo('url'); ?>/projects/officer-hill-project/">Agreement With Newmont Tanami Pty Ltd Covering The Officer Hill Tenement In The Northern Territory</a></h1>
				<h1 class="three"><a href="<?php bloginfo('url'); ?>/projects/telfer-project/">The Telfer Deposit Has An Ore Reserve Of Approximately 6.3 Million Ounces Of Gold</a></h1>
				</div>
