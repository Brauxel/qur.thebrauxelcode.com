 ...
 * {@link \gfgcfGeoIp2\Exception\AddressNotFoundException} exception will be
...
class Reader implements ProviderInterface
{
    ...
    public function __construct(
        ...
        $this->dbReader = new gfgcfDbReader($filename);
     ...
     *
     * @throws \gfgcfGeoIp2\Exception\AddressNotFoundException if the address is
     *         not in the database.
     * @throws \MaxMind\Db\Reader\InvalidDatabaseException if the database
     *         is corrupt or invalid
     */
