...
namespace gfgcfGeoIp2\WebService;

use gfgcfGeoIp2\Exception\AddressNotFoundException;
use gfgcfGeoIp2\Exception\AuthenticationException;
use gfgcfGeoIp2\Exception\GeoIp2Exception;
use gfgcfGeoIp2\Exception\HttpException;
use gfgcfGeoIp2\Exception\InvalidRequestException;
use gfgcfGeoIp2\Exception\OutOfQueriesException;
use gfgcfGeoIp2\ProviderInterface;
...
class Client implements ProviderInterface
{
     ...
     * from will be used.
     *
     * @return \gfgcfGeoIp2\Model\City
     *
     * @throws \gfgcfGeoIp2\Exception\AddressNotFoundException if the address you
     *   provided is not in our database (e.g., a private address).
     * @throws \gfgcfGeoIp2\Exception\AuthenticationException if there is a problem
     *   with the user ID or license key that you provided.
     * @throws \gfgcfGeoIp2\Exception\OutOfQueriesException if your account is out
     *   of queries.
     * @throws \gfgcfGeoIp2\Exception\InvalidRequestException} if your request was
     ...
     *   MaxMind.
     * @throws \gfgcfGeoIp2\Exception\HttpException if an unexpected HTTP error
     ...
     * @throws \gfgcfGeoIp2\Exception\GeoIp2Exception This serves as the parent
     ...
     * from will be used.
     *
     * @return \gfgcfGeoIp2\Model\Country
     *
     * @throws \gfgcfGeoIp2\Exception\AddressNotFoundException if the address you
     *   provided is not in our database (e.g., a private address).
     * @throws \gfgcfGeoIp2\Exception\AuthenticationException if there is a problem
     ...
     * from will be used.
     *
     * @return \gfgcfGeoIp2\Model\CityIspOrg
     *
     * @throws \gfgcfGeoIp2\Exception\AddressNotFoundException if the address you
     *   provided is not in our database (e.g., a private address).
     * @throws \gfgcfGeoIp2\Exception\AuthenticationException if there is a problem
